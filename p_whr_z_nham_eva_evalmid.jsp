...
<tiles:putAttribute name="content">
	<!--   
		...
		수정자 : 
		수정일 :
		수정내용 : p_whr_z_nham_eva_evalmid.jsp
	 -->
    <!-- 버튼영역 시작 -->
			 ...
			 var row = grid.select();
			    ...
			    if(rowData){
		    		var initData = {
		    				...
		    				pFilePath: "",
							pCdFile: rowData.YM_EVLU + "_" + rowData.CD_EVUNIT + "_" + rowData.CD_EVGROUP + "_" + rowData.NO_EMP + "_0", //피평가자의 사번으로 확인해야 되지 않나?		
							params: {
								data: rowData
							}
					};
...
//         	rowData = grid.dataItem(rows);
			//dews.error(dews.localize.get("승인된 데이터는 삭제할 수 없습니다."))	
