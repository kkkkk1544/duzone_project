...
@Service("p_whr_z_nham_eva_rslt1")
public class p_whr_z_nham_eva_rslt1 extends DzErpiuServiceBase {
	...
	protected DzResponseModel executeInternal(DzRequestModel requestModel) throws Exception {
		...
		this.logger.info("ORDER executeInternal start ::: p_whr_z_nham_eva_rslt1");
...
//				responseModel.setResultDataTable(dt);
	...
	private DataTable GetList(DzRequestModel dzRequestModel, String companyCode){
		...
		try{
			...
			sp.getInParameters().put("P_S_NO_EMP",   noEmp);
