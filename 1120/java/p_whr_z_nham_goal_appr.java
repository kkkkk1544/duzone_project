...
@Service("p_whr_z_nham_goal_appr")
public class p_whr_z_nham_goal_appr extends DzErpiuServiceBase {
	...
	protected DzResponseModel executeInternal(DzRequestModel requestModel) throws Exception {
		...
		this.logger.info("ORDER executeInternal start ;;; p_whr_z_nham_wreathapply_pop");
		// TODO Auto-generated method stub
		...
		try{		
			...
			if(StringUtil.equals(requestModel.getActionName(), "list_subject") ){  //대상자 항목
				...
				DataTable dt = this.getSubjectLsit(cd_company, ym_evlu, cd_evunit, cd_evgroup, yn_approve, no_emp);
				...
				this.Approve(p_cd_company,ym_evlu,cd_evunit
						,cd_evgroup,p_no_emp,app_flag);
			}
	...
	private DataTable getSubjectLsit(String cd_company, String ym_evlu,
			String cd_evunit, String cd_evgroup, String yn_approve, String no_emp ) {
		DataTable dt = null;
		try{
