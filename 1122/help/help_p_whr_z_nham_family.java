...
@Service("help_p_whr_z_nham_family")
public class help_p_whr_z_nham_family extends DzErpiuServiceBase {
	...
	protected DzResponseModel executeInternal(DzRequestModel requestModel) throws Exception {
		...
		this.logger.info("ORDER executeInternal start ;;; help_p_whr_z_nham_family");
		// TODO Auto-generated method stub
	...
	private DataTable GetFamily(String cd_company, String no_emp, String keyword){
		...
		try{
			String sqlText = "UP_WHR_Z_NHAM_FAMILY_SUB_S";		//UP_WEB_WHR_Z_NHAM_FAMILY_SUB_S
