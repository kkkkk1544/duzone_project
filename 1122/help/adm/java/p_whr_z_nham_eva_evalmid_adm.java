 ...
 * 수정자 : 
 * 수정일 :
 * 수정내용 : p_whr_z_nham_eva_evalmid_adm
 */
@DefaultViewPath(path="/customize/nham/")
@Service("p_whr_z_nham_eva_evalmid_adm")
public class p_whr_z_nham_eva_evalmid_adm extends DzErpiuServiceBase {
	...
	protected DzResponseModel executeInternal(DzRequestModel requestModel) throws Exception {
		...
		this.logger.info("ORDER executeInternal start ;;; p_whr_z_nham_eva_evalmid_adm");
		// TODO Auto-generated method stub
		...
		try{		
			...
			if(StringUtil.equals(requestModel.getActionName(), "AdminEmpList")){	//목표대상
			...
			}else if(StringUtil.equals(requestModel.getActionName(), "AdminDataSave") ){  //평가자 의견
				...
				logger.info(cd_company+";;;"+NoEmp+";;;"+ ym_evlu+";;;"+ cd_evunit+";;;"+ cd_evgroup+";;;"+ no_itemseq+";;;"+ no_seq+";;;"+ no_subjectE);
				
				this.SaveData(cd_company, NoEmp, no_subjectE, ym_evlu, cd_evunit, cd_evgroup, no_itemseq, no_seq,requestModel.getGridData());
			}
...
//				so.getInParameters().put("P_CD_INPUT", "200");		//입력구분  (100 : 성과기록, 200 : 중간평가)
	...
	@Transactional
	private void SaveData(String cd_company,String NoEmp,String no_subjectE, String ym_evlu,String cd_evunit,String cd_evgroup,
