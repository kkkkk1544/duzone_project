...
@Service("p_whr_z_nham_eva_rslt2_adm")
public class p_whr_z_nham_eva_rslt2_adm extends DzErpiuServiceBase {
	...
	protected DzResponseModel executeInternal(DzRequestModel requestModel) throws Exception {
		...
		this.logger.info("ORDER executeInternal start ::: p_whr_z_nham_eva_rslt2_adm");
