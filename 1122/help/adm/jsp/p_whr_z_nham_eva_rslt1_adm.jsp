...
<tiles:putAttribute name="content">
	<!--   
		...
		수정자 : 
		수정일 :
		수정내용 : p_whr_z_nham_eva_rslt1_adm.jsp
	 -->
...
<!-- 	                		data-dews-data-url='~/Data/help_p_whr_z_nham_eva_group/EvaGroup' -->
	...
	<script>
	var grid, grid2, dataSource1, dataSource2, rsltSclDataSource, sclArr, changeData, admin;
...
//   	alert(JSON.stringify(data));
	...
	$("#btn_search").on("click", function() {
		...
		dews.ajax.data(dews.url.getDataUrl("p_whr_z_nham_eva_rslt1_adm","planCheck"),{
    		async : false,
			data  : {
	...
	$('#btn_save').on('click', function (e) {
		...
		dews.ajax.data(dews.url.getDataUrl("p_whr_z_nham_eva_rslt1_adm","checkData"),{
    		async : false,
			data  : {
   				ym_evlu : dews.ui.dropdownlist("#ym_evlu").value(),
   				cd_evunit : dews.ui.dropdownlist("#cd_evunit").value(),
		...
		dews.confirm('저장하시겠습니까?').yes(function() {
			sSourse.batchSave(dews.urlHelper.getDataUrl("p_whr_z_nham_eva_rslt1_adm", "rslt1Insert"),{
	       		async : false,
	   			data  : {
	   				ym_evlu : dews.ui.dropdownlist("#ym_evlu").value(),
	   				cd_evunit : dews.ui.dropdownlist("#cd_evunit").value(),
	...
	$('#btn_submit_deadline').on('click', function (e) {
		...
		dews.confirm('입력마감 하시겠습니까?').yes(function() {
			sSourse.batchSave(dews.urlHelper.getDataUrl("p_whr_z_nham_eva_rslt1_adm", "deadLineUpdate"),{
	       		async : false,
	   			data  : {
	   				ym_evlu : dews.ui.dropdownlist("#ym_evlu").value(),
	   				cd_evunit : dews.ui.dropdownlist("#cd_evunit").value(),
	...
	$('#btn_cancel_deadline').on('click', function (e) {
		...
		//마감취소 가능여부 확인
		dews.ajax.data(dews.url.getDataUrl("p_whr_z_nham_eva_rslt1_adm","checkDeadline"),{
    		async : false,
			data  : {
   				ym_evlu : dews.ui.dropdownlist("#ym_evlu").value(),
   				cd_evunit : dews.ui.dropdownlist("#cd_evunit").value(),
	...
	function selectData() {
		...
		dews.ajax.data( dews.url.getDataUrl("p_whr_z_nham_eva_rslt1_adm", "getList"), {
	        async: false,
	        data:{
               	ym_evlu : dews.ui.dropdownlist("#ym_evlu").value(),
               	cd_evunit : dews.ui.dropdownlist('#cd_evunit').value(),
	...
	function rsltSclList(cd_scaleh){
		dews.ajax.data(dews.url.getDataUrl("p_whr_z_nham_eva_rslt1_adm","rsltSclList"),{
    		async : false,
			data  : {
				ym_evlu : dews.ui.dropdownlist("#ym_evlu").value(),
				cd_scaleh : cd_scaleh
...
//     		sclArr.push({CD_SYSDEF:"", NM_SYSDEF : ""});
	...
	function rsltScmList(cd_scaleh, cd_scaled, num_item){
		...
		dews.ajax.data(dews.url.getDataUrl("p_whr_z_nham_eva_rslt1_adm","rsltScmList"),{
    		async : false,
			data  : {
				ym_evlu : dews.ui.dropdownlist("#ym_evlu").value(),
				cd_scaleh : cd_scaleh,
